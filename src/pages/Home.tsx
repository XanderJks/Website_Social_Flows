      ...
      <main className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-32">
          <div className="max-w-4xl mx-auto text-center">
            {/* Badge */}
            <div className={`inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium bg-white/80 backdrop-blur-xl border border-gray-300/50 text-gray-700 mb-8 transition-all duration-800 shadow-lg ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <Shield className="w-4 h-4 mr-2 text-blue-400" />
              Enterprise AI Oplossingen
            </div>
            
            {/* Main Headline */}
            <h1 className={`text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-gray-800 via-blue-600 to-gray-900 bg-clip-text text-transparent mb-8 leading-tight transition-all duration-800 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              Professionele AI-assistenten voor uw restaurant
            </h1>
            
            {/* Subheadline */}
            <p className={`text-lg sm:text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed transition-all duration-800 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className={`mb-10 transition-all duration-800 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <div className="relative max-w-4xl mx-auto">
                <div className="aspect-video bg-white/60 rounded-xl border border-gray-300/50 backdrop-blur-xl flex items-center justify-center shadow-lg">
                  <button className="group flex items-center justify-center w-20 h-20 bg-blue-600/20 backdrop-blur-xl rounded-full border border-blue-500/30 hover:bg-blue-600/30 transition-all duration-300 shadow-md">
            ...
            {/* Trust Indicators */}
            <div className={`mt-16 flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-gray-500 transition-all duration-800 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <div className={`mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto transition-all duration-800 delay-1100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <div className="group relative p-8 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl hover:bg-white/80 transition-all duration-300 shadow-lg">
                <div className="relative z-10 text-center">
                  <div className="w-14 h-14 bg-blue-600/20 rounded-xl flex items-center justify-center mx-auto mb-6">
                    <Clock className="w-6 h-6 text-blue-400" />
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3">24/7 Beschikbaarheid</h3>
              ...
              <div className="group relative p-8 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl hover:bg-white/80 transition-all duration-300 shadow-lg">
                <div className="relative z-10 text-center">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Enterprise Betrouwbaarheid</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="group relative p-8 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl hover:bg-white/80 transition-all duration-300 shadow-lg">
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Geautomatiseerde Reserveringen</h3>
              ...
              <div className="group relative p-8 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl hover:bg-white/80 transition-all duration-300 shadow-lg">
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Intelligente Bestellingen</h3>
                  <p className="text-gray-700 mb-6 leading-relaxed text-base">
              ...
              <div className="group relative p-8 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl hover:bg-white/80 transition-all duration-300 shadow-lg">
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Professionele Klantenservice</h3>
                  <p className="text-gray-700 mb-6 leading-relaxed text-base">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Bewezen ROI</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Enterprise Beveiliging</h3>
                <p className="text-gray-600 leading-relaxed">
        ...
        <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* Starter Plan */}
              <div className="relative p-8 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl hover:bg-white/80 transition-all duration-300 flex flex-col h-full shadow-lg">
                <div className="relative z-10 text-center flex flex-col h-full">
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Starter</h3>
                  <div className="mb-6">
                    <span className="text-3xl font-bold text-gray-900">€289</span>
                  ...
                  <ul className="space-y-3 mb-8 text-left flex-grow">
                    ...
                    <li className="flex items-center text-sm text-gray-600 opacity-0">
                      <CheckCircle className="w-4 h-4 mr-3 text-blue-400 flex-shrink-0" />
                      Spacer item
                    </li>
                  </ul>
                  <button className="w-full py-3 px-6 bg-gray-200/80 hover:bg-gray-300/80 text-gray-800 font-semibold rounded-lg transition-all duration-300 backdrop-blur-xl border border-gray-400/30 hover:border-gray-500/50">
                    Start Nu
                  </button>
                </div>
              </div>
              ...
              {/* Pro Plan */}
              <div className="relative p-8 rounded-xl bg-white/60 border border-orange-500/50 backdrop-blur-xl hover:bg-white/80 transition-all duration-300 flex flex-col h-full group shadow-lg">
              ...
              <div className="relative p-8 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl hover:bg-white/80 transition-all duration-300 flex flex-col h-full shadow-lg">
                <div className="relative z-10 text-center flex flex-col h-full">
                  ...
                  <div className="mb-6">
                    <span className="text-2xl font-bold text-gray-900">Op maat</span>
                  </div>
                  <ul className="space-y-3 mb-8 text-left flex-grow">
                    <li className="flex items-center text-sm text-gray-600">
                      <CheckCircle className="w-4 h-4 mr-3 text-blue-400 flex-shrink-0" />
            ...
            <div className="mt-16 text-center">
              <h4 className="text-xl font-bold text-gray-900 mb-6">Uitbreidingen</h4>
              <div className="space-y-4 text-gray-600 max-w-4xl mx-auto">
                <div className="p-6 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl shadow-lg">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-gray-900 font-semibold">Business Line</p>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-gray-900 font-semibold">Enterprise Sales</p>
                        <p className="text-gray-600">enterprise@socialflows.nl</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Ma-Vr 9:00-18:00 CET</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 rounded-xl bg-white/60 border border-gray-300/50 backdrop-blur-xl shadow-lg">
                  <h4 className="text-lg font-bold text-gray-900 mb-3">Enterprise Consultatie</h4>
                  <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <div className="relative">
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  {/* Error Message */}
                  {submitStatus === 'error' && (
                    <div className="p-4 rounded-lg bg-red-100/80 border border-red-300/50 backdrop-blur-xl">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        id="firstName"
                        name="firstName"
                        className="w-full px-4 py-3 bg-white/60 border border-gray-300/50 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-blue-400 focus:bg-white/80 transition-all duration-300 backdrop-blur-xl shadow-sm"
                  ...
                  <div>
                    <label htmlFor="restaurant" className="block text-sm font-semibold text-gray-900 mb-2">
                      Bedrijfsnaam
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      name="message"
                      className="w-full px-4 py-3 bg-white/60 border border-gray-300/50 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-blue-400 focus:bg-white/80 transition-all duration-300 backdrop-blur-xl resize-none shadow-sm"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                <h3 className="text-xl font-bold text-gray-900 mb-4">SocialFlows</h3>
                <p className="text-gray-600 mb-4 max-w-md">
                  Enterprise AI-oplossingen voor de moderne horeca. 
                  Bewezen technologie voor operationele excellentie.
                </p>
                <div className="flex space-x-4">
                  <div className="w-8 h-8 bg-gray-200/80 rounded-lg flex items-center justify-center hover:bg-gray-300/80 transition-colors cursor-pointer">
                    <span className="text-gray-700 text-xs font-bold">f</span>
                  </div>
                  <div className="w-8 h-8 bg-gray-200/80 rounded-lg flex items-center justify-center hover:bg-gray-300/80 transition-colors cursor-pointer">
                    <span className="text-gray-700 text-xs font-bold">t</span>
                  </div>
                  <div className="w-8 h-8 bg-gray-200/80 rounded-lg flex items-center justify-center hover:bg-gray-300/80 transition-colors cursor-pointer">
                    <span className="text-gray-700 text-xs font-bold">in</span>
                  </div>
                </div>
              </div>
              
              <div>
                <h4 className="text-gray-900 font-semibold mb-4">Oplossingen</h4>
                <ul className="space-y-2">
                  <li><a href="#features" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Enterprise AI</a></li>
                  <li><a href="#pricing" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Prijsmodellen</a></li>
                  <li><a href="#demo" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Live Demo</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#contact" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Contact Sales</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Documentatie</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">System Status</a></li>
                </ul>
              </div>
            </div>
            
            <div className="mt-8 pt-8 border-t border-gray-200/50 flex flex-col sm:flex-row justify-between items-center">
