...
export function Restaurants() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      source: 'SocialFlows Restaurant Website'
    };
  ...
  return (
    <>
      <SEOHead 
        title="Voice AI voor Restaurants - SocialFlows"
        ...
        url="https://socialflows.nl/restaurants"
      />
        ...
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className={`text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-green-600 via-green-700 to-green-800 bg-clip-text text-transparent mb-8 leading-tight transition-all duration-800 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              Voice AI assistenten voor uw restaurant
            </h1>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-6">
                AI-oplossingen speciaal voor restaurants
              </h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Transparante Prijzen voor Restaurants
              </h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">
                Wat onze restaurant klanten zeggen
              </h2>
        ...
        <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">
                Start uw restaurant transformatie
              </h2>
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                Neem contact op voor een vrijblijvend gesprek en ontdek hoe SocialFlows uw restaurant kan optimaliseren
              </p>
            </div>
              ...
              <div className="space-y-8">
                ...
                <div className="p-6 rounded-xl bg-white/90 border border-green-200/30 backdrop-blur-xl shadow-lg">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    Persoonlijke analyse van uw restaurant processen en een op maat gemaakte implementatiestrategie. 
